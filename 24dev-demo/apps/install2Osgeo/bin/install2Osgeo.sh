...
echo "Source the 24dev profile for this script and display the variables..."
. ${BASE}/.24dev.profile 
...
echo "Make all of the $MYDEV_NAME files executable..." 
chmod -R 755 ${BASE}
...
chkerr "$?" "1" "The following command failed: cat ${DOCS}/24dev-r4st-Release-License.txt"   
echo
echo
